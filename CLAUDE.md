...
- `docs/architecture/debate-review.md` — design proposal, not implemented: an optional FOR/AGAINST/JUDGE triple-pass review (adapted from `fxg55647/leima`'s `neutral_witness.py`), open questions on activation strategy and cost before any code is written
